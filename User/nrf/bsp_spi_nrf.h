...
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOB, GPIO_Pin_15)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOB, GPIO_Pin_15)		        //csn置低

#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOB,GPIO_Pin_5)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOB,GPIO_Pin_5)			      //CE置低
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit ( GPIOB, GPIO_Pin_4)  //中断引脚
